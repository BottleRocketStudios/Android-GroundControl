...
public class AgentPolicyCache {
    ...
    public void put(String agentPolicyIdentifier, AgentPolicy agentPolicy) {
        mAgentPolicyMap.put(agentPolicyIdentifier, agentPolicy);
    }

    public AgentPolicy get(String agentPolicyIdentifier) {
        return mAgentPolicyMap.get(agentPolicyIdentifier);
    }
}
